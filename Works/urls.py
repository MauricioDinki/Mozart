...
from .views import WorkListView, HomeView, WorkUploadView, WorkSettingsView, WorkEditView, WorkUserDetailView,WorkUserView
# from .views import WorkListView, HomeView, WorkUploadView, WorkSettingsView, WorkEditView, WorkUserDetailView
