...
app.directive('thumbnailObra', [function(){
	return{
		restrict: 'E',
		templateUrl: 'scripts/directives/thumbnailobra.html'
	};
}]);
...
app.directive('imagenAutor', [function(){
	return{
		restrict: 'E',
		templateUrl: 'scripts/directives/imagenautor.html'
	};
}]);
...
app.directive('tituloObra', [function(){
	return{
		restrict: 'E',
		templateUrl: 'scripts/directives/tituloobra.html'
	};
}]);
...
app.directive('autorFecha', [function(){
	return{
		restrict: 'E',
		templateUrl: 'scripts/directives/autoryfecha.html'
	};
}]);
