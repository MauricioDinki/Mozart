...
app.directive('thumbnailObra', [function(){
	return{
		restrict: 'E',
		templateUrl: 'static/js/directives/thumbnailobra.html'
	};
}]);
...
app.directive('imagenAutor', [function(){
	return{
		restrict: 'E',
		templateUrl: 'static/js/directives/imagenautor.html'
	};
}]);
...
app.directive('tituloObra', [function(){
	return{
		restrict: 'E',
		templateUrl: 'static/js/directives/tituloobra.html'
	};
}]);
...
app.directive('autorFecha', [function(){
	return{
		restrict: 'E',
		templateUrl: 'static/js/directives/autoryfecha.html'
	};
}]);
...
app.directive('modalDialog', function() {
	return {
		...
		templateUrl: 'static/js/directives/ventanaModal.html'
	};
});
